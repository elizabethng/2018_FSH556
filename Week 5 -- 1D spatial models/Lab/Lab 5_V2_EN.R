...
setwd("~/Documents/GitHub/2018_FSH556/Week 5 -- 1D spatial models/Lab")
...
# Using gaussian correlation function, shoudl be same
# formula, only we calculate rho diffeently
...
compile( "unequal_distance_autoregressive_V2_EN.cpp" )
