...
RMmodel = RMexp(var=Sigma2, scale=Scale) # in random fields package, exponential function. we could do this ourselves too
# random effect of space
...
# zero, first, and second order adjacency
